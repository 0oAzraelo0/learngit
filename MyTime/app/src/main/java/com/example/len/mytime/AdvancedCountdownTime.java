 ...
 */
public abstract class AdvancedCountdownTime {
    ...
    // 构造函数
    public AdvancedCountdownTime(long millisInFuture, long countDownInterval) {
    ...
    // 开始计时
    public synchronized final AdvancedCountdownTime start() {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            synchronized (AdvancedCountdownTime.this) {
                if (msg.what == MSG_RUN) {
